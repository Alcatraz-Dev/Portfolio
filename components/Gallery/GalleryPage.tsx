        ...
        <div className="relative w-full h-full rounded-md ">
          {galleryProject?.images?.map((imageSrc, imageIndex) => (
            ...
            >
              ...
              >
                <div key={imageIndex}>
                  <div className="text-white text-2xl font-bold mb-2 drop-shadow-lg z-50  ">
                    {galleryProject?.authorName}
                  </div>
                  <div className="text-white text-5xl font-bold mb-2 pr-10 drop-shadow-lg z-50">
                    {galleryProject?.projectTitle}{" "}
                    <span className="text-lime-500 drop-shadow-lg z-50">
                      {galleryProject?.titleSpan}
                    </span>
                  </div>
                  <div className="text-white text-2xl mb-4 drop-shadow-lg z-50">
                    {galleryProject?.categoryOrTag}
                  </div>
                  <div className=" text-white flex justify-between space-x-2 pr-20 drop-shadow-lg z-50">
