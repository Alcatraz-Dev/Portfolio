          ...
          <div className="relative rounded-2xl  bg-white dark:bg-zinc-700/40 px-6 pt-10 pb-8 shadow-lg ring-1 ring-gray-900/5 ">
            <div ref={boxRef} className="mx-auto max-w-md">
              <form action="" className="relative mx-auto w-max">
                <input
                  type="search"
                  className=" peer cursor-pointer relative z-10 h-10 w-10 rounded-full  border bg-transparent pl-10 outline-none focus:w-full focus:cursor-text focus:border-purple-300 focus:pl-14 focus:pr-5"
