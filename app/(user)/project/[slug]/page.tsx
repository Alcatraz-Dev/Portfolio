    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <Image
          ...
          fill
          src={urlFor(project?.mainImage).width(500).height(500).url()}
          alt={project?.title}
        />
        ...
        >
          ...
          <div className="p-5">
            ...
            <p
              key={project?._id}
              className={`my-3 absolute  ${project?.tagBgColor} backdrop-blur-md ${project?.tagTitleColor} font-semibold py-1 px-3 rounded-br-lg rounded-tl-lg`}
            >
      ...
      <div className="grid grid-cols-3 md:grid-cols-1 ">
        <Link href="/#projects">
          <p
            className={`mt-10 mb-10 mx-5  rounded-lg w-32 h-auto p-2 cursor-pointer items-center hover:scale-105 ease-in duration-300 ${project?.buttonBgColor} ${project?.buttonHoverBgColor}`}
          >
